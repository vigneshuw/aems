...
- command `98`: configures the ADS path around 2000 Hz, ignores the first 5 seconds, averages channels `0..5` for the next 10 seconds, saves the six averages, and returns them
