#ifndef _ADS131M08_H_
#define _ADS131M08_H_
...
//****************************************************************************
/*
 * Note: The register definitions can change. Please refer to datasheet for more up to date information.
 */
 ...
 */
	...
	#define CLOCK_EXTREF_EN_DISABLED										((uint16_t) 0x0000 << 6)

	/* Crystal oscillator disable */
	#define CLOCK_XTAL_DIS_MASK												((uint16_t) 0x0080)
	#define CLOCK_XTAL_DIS_ENABLED											((uint16_t) 0x0000 << 7)
...
// Master Functions
extern void adcMaster_Startup(void);
extern void adcMaster_Shutdown(void);
...
#define ADS131M08_CS_LOW()  HAL_GPIO_WritePin(ads.cs_port, ads.cs_pin, GPIO_PIN_RESET)
#define ADS131M08_CS_HIGH() HAL_GPIO_WritePin(ads.cs_port, ads.cs_pin, GPIO_PIN_SET)

// SPI Config for AEMS Board
typedef struct {
...
// From main.c to setup
extern ADS131M08_HandleTypeDef ads;
// GPIO Pins for ADS
extern GPIO_TypeDef *SYNC_RESET_GPIO_Port;
