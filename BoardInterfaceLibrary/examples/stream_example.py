...
def main() -> None:
    ...
    try:
        ...
        if args.mode == "file":
            # Command 8 style file stream: either write the raw bytes directly, or stage a temporary
            # binary file and convert it into the same parsed CSV format used for DAQ streaming.
